...
const GameEntryPoint = props => {
    ...
    const worldMeshesURL = useRef([serverLocation.current+"/assets/environment26.glb",serverLocation.current+"/assets/environment27.glb",serverLocation.current+"/assets/environment29_coins_simple_rot.glb",serverLocation.current+"/assets/environment32_simple.glb"]);
    ...
    const setUpGame = async () => {
      ...
      //  gameScene.current.getEngine().hideLoadingUI(); // gameScene.current.getEngine().displayLoadingUI();
       ...
       // this.worldManager.render();
        character.current = new Character(gameScene.current, worldManager.current.assetsManager, serverLocation.current,frameRate/20.0);
    ...
    //    gameScene.current.getEngine().displayLoadingUI();
    //    await gameScene.current.whenReadyAsync();
    //    setTimeout(()=>{
...
const initializeCharacter = async () => {
    ...
    const loadMap = async () => {
        ...
        let rootUrl = "./assets/";
        BABYLON.SceneLoader.ImportMeshAsync("", "/assets/coin.glb", "", gameScene.current)
            .then((meshes) => {
    ...
    useEffect(() => {
        const initScene = async () => {
          ...
          //  await loadMap();
            ...
            // gameEngine.current.runRenderLoop(() => {
